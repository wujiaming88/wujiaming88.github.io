---
title: "全球 AI 投资研究周报 · 第 1 期（2026-06-02 ~ 2026-06-08）"
date: 2026-06-09 10:30:00 +0800
categories: [AI]
tags: [投资周报, AI投资, 算力, 芯片, 大模型, 国产替代, 中美博弈, 产业链]
header:
  overlay_image: /assets/images/posts/2026-06-09-global-ai-investment-weekly-header.png
  overlay_filter: 0.5
  caption: "AI 产业链自底向上：能源 → 基础设施 → 芯片 → 模型 → 应用与资本市场"
excerpt: "本周是「AI 巨头 IPO 竞赛全面引爆 + 中国大模型集体资本化」的标志性一周：Anthropic、OpenAI 先后机密递表，估值逼近万亿；聚变/液冷融资爆发，电力成 AI 第一约束。"
toc: true
toc_sticky: true
---
...
```mermaid
graph LR
  A[美国 BIS 50%穿透式<br/>出口管制收紧 6/1] --> B[国产算力订单↑<br/>DeepSeek V4 适配昇腾/寒武纪]
  B --> C[三省设备首台套补贴 6/3<br/>国产替代订单驱动]
  C --> D[大基金/国资加码晶圆厂<br/>CXMT/YMTC 扩产]
  E[数据中心电力缺口实锤<br/>PJM电价+76% 6/7] --> F[离网燃气/聚变自备电源<br/>Helion/Nscale]
  F --> G[算力capex $650B+<br/>HBM超级周期]
  G --> H[模型训练/推理<br/>架构降本30%]
  H --> I[应用变现+IPO退出<br/>Anthropic/OpenAI/六小龙]
```
